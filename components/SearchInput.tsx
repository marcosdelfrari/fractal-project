  ...
  return (
    <form className="flex w-full justify-center" onSubmit={searchProducts}>
      <input
        ...
        className="bg-[#E3E1D6] input input-bordered w-[70%] rounded-r-none outline-none focus:outline-none max-sm:w-full"
      />
      <button
        type="submit"
        className="btn bg-zinc-900 text-white rounded-l-none rounded-r-xl hover:bg-blue-600"
      >
        Search
      </button>
    </form>
