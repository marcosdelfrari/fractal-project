  ...
  return (
    <div className="bg-white flex min-h-screen max-w-screen-2xl mx-auto max-lg:flex-col animate-fade-in-up">
      ...
      <div className="flex-1 p-10 max-md:p-4 pb-admin-mobile-nav">
        ...
        <div className="mt-8 p-6 bg-red-50/50 border border-red-100 rounded-3xl">
          ...
          <p className="text-xs text-red-500 font-light leading-relaxed">
            Categorias com produtos vinculados não podem ser excluídas. Mova os
            produtos para outra categoria antes de prosseguir.
          </p>
        </div>
      </div>
      ...
      <ConfirmDialog
        ...
        onClose={() => !isDeleting && setDeleteCategoryOpen(false)}
        title="Excluir categoria?"
        description="Apenas categorias sem produtos vinculados podem ser removidas. Esta ação não pode ser desfeita."
