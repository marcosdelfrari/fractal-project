...
const SingleProductPage = async ({ params }: SingleProductPageProps) => {
  ...
  return (
    <div className="bg-white text-gray-800 pb-24 lg:pb-16">
      <div className="max-w-screen-2xl mx-auto px-5 py-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          {/* Left Column: Gallery */}
          <div className="lg:col-span-7 flex gap-4 h-fit lg:sticky lg:top-4">
            {/* Thumbnails (Vertical) */}
            <div className="hidden md:flex flex-col gap-4 w-24 max-h-[600px] overflow-y-auto">
              {product?.mainImage && (
            ...
            {/* Main Image */}
            <div className="flex-1 bg-white relative aspect-[4/5] w-full overflow-hidden">
              <Image
                src={
                  product?.mainImage
                    ? `/${product?.mainImage}`
