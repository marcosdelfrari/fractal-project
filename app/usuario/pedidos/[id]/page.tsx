...
export default function OrderDetailsPage() {
  ...
  useEffect(() => {
    const fetchOrderDetails = async () => {
      ...
      try {
        ...
        const orderResponse = await fetchNextApi(`/api/orders/${orderId}`);
  ...
  if (error || !order) {
    return (
      <div className="min-h-screen bg-[#E3E1D6] py-8">
  ...
  return (
    <div className="min-h-screen bg-[#E3E1D6] py-8 print:bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="mb-8 print:hidden">
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={handlePrint}
              className="flex items-center gap-2 px-4 py-2 bg-white border border-gray-300 rounded-lg hover:bg-[#E3E1D6] transition-colors"
            >
              <FaPrint />
              Imprimir
            </button>
                ...
                {order.products.map((orderProduct) => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      {(orderProduct.selectedColor || orderProduct.selectedSize) && (
                        <p className="text-xs text-gray-500">
                          {orderProduct.selectedColor ? `Cor: ${orderProduct.selectedColor}` : ""}
                          {orderProduct.selectedColor && orderProduct.selectedSize ? " • " : ""}
                          {orderProduct.selectedSize ? `Tamanho: ${orderProduct.selectedSize}` : ""}
                        </p>
                      )}
                    </div>
